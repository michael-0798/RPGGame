...
import com.algonquincollege.cst8284.assignment2.model.RedDragon;
import com.algonquincollege.cst8284.assignment2.model.AttackReport;
import com.algonquincollege.cst8284.assignment2.model.BlueDragon;
...
public class CharacterGame {
	 ...
	 * there will be 5 RedDragon objects and 5 BlueDragon objects in the array
	 */
	public CharacterGame() {
		for(int index = 0; index < characters.length; index++) {
			if(index%2==0) {
				characters[index] = new RedDragon();
			}else {
				characters[index] = new BlueDragon();
			}
		}
	}
